        ...
        <MainLayout title="Batik Kombinasi Wanita - Blouse Navy Red" px='5rem' pb='3rem'>
            ...
            <Flex pb='5rem' gap='3rem' >
                <VStack spaceY='1rem' w='50%'>
                    ...
                    <HStack w='full' spaceX={'1rem'}>
                        <Image src={'/detail-product-2.jpg'} aspectRatio='square' w='10rem' />
                        <Image src={'/detail-product-3.jpg'} aspectRatio='square' w='10rem' />
                        <Image src={'/detail-product-4.jpg'} aspectRatio='square' w='10rem' />
                    </HStack>
                </VStack>
